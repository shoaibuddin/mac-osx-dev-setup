...
This document describes how I set up my developer environment on a new MacBook or iMac. We will set up [Node](http://nodejs.org/) (JavaScript) environments, mainly for JavaScript development. Even if you don't program in it, it is good to have them as many command-line tools use one of them.
